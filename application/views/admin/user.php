        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/user/importexcel') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <font color="red">
                        <small><i>NB : Hanya file berformat <b>xlsx</b> dan <b>xls</b> yang dapat diupload!</i></small>
                    </font>
                </div>
                <div class="modal-footer">
                    <a href="<?= base_url('assets/file_excel/example/import_user.xlsx') ?>" class="btn btn-success pull-left"><div class="fa fa-download"></div> Template</a>
                    <button type="reset" class="btn btn-danger"><div class="fa fa-trash"></div> Reset</button>
