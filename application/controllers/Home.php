...
class Home extends CI_Controller {
    ...
    {
        if ($this->session->userdata('level') == 'Administrator' OR $this->session->userdata('level') == 'Bidan') {
                        ...
                        if(password_verify($password, $row['password'])) {
                            ...
                            if($row['login'] == 'Ya') {
                                ...
                                if($row['level'] == 'Administrator') {
                                    ...
                                    redirect('admin/dashboard');
                                } elseif ($row['level'] == 'Orang Tua') {
                                    $this->session->set_flashdata('pesan', 'Mohon maaf, Tidak login untuk orang tua!');
                                    redirect('home');
                                }
